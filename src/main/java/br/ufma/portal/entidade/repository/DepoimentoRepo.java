...
public interface DepoimentoRepo
        extends JpaRepository<Depoimento, Integer> {
                @Query("select new br.ufma.portal.entidade.dto.EgressoDepoimentoDto(d.id_depoimento, d.texto, d.data) from Depoimento d inner join  d.egresso_id e where e.id_egresso = :idEgresso")
